...
const defaultNameFn: nameFnType = (
  ...
  return `${file.fieldname}_${Date.now()}_LUX50001${fileExt}`;
};
...
class GoogleCloudStorageUpload implements multer.StorageEngine {
...
export default (opts: Options) => {
  return new GoogleCloudStorageUpload(opts);
};
